...
from {packagename_file}.__version__ import version as __version__
...
latex_documents = [
    (master_doc, '{packagename_file}.tex', u'{packagename} Documentation',
     u'{author}', 'manual'),
]
...
man_pages = [
    (master_doc, '{packagename_file}', u'{packagename} Documentation',
     [author], 1)
]
