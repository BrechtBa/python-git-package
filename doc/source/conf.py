...
from python_git_package.__version__ import version as __version__
...
latex_documents = [
    (master_doc, 'python_git_package.tex', u'python-git-package Documentation',
...
man_pages = [
    (master_doc, 'python_git_package', u'python-git-package Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'python_git_package', u'python-git-package Documentation',
     author, 'python-git-package', 'A scaffoling tool for python packages',
     'Miscellaneous'),
]
